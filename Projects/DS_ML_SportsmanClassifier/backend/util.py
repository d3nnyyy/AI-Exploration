...
if __name__ == '__main__':
    ...
    print(classify_img(get_b64_test_image_for_messi(), None))
    print(classify_img(None, "../model/test_images/MESSI.jpg"))
    print(classify_img(None, "../model/test_images/serema.jpeg"))
    print(classify_img(None, "../model/test_images/17kohli1.jpg"))
